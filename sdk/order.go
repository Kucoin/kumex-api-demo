...
func (as *ApiService) CreateOrder(side, symbol, leverage, price, size string) (*ApiResponse, error) {
...
//
func (as *ApiService) GetStopOrders(symbol string) (*ApiResponse, error) {
	p := map[string]string{}
	if symbol != "" {
		p["symbol"] = symbol
	}
...
func (as *ApiService) Orders() (*ApiResponse, error) {
	params := map[string]string{}
