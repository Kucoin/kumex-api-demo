...
func (as *ApiService) Level2MessageQuery(symbol, start, end string) (*ApiResponse, error) {
...
func (as *ApiService) InterestQuery(symbol string) (*ApiResponse, error) {
...
func (as *ApiService) IndexQuery(symbol string) (*ApiResponse, error) {
	params := map[string]string{"symbol": symbol}
	pagination := &PaginationParam{CurrentPage: 1, PageSize: 10}
	pagination.ReadParam(params)
	req := NewRequest(http.MethodGet, "/api/v1/interest/query", params)
...
func (as *ApiService) PremiumQuery(symbol string) (*ApiResponse, error) {
	params := map[string]string{"symbol": symbol}
	pagination := &PaginationParam{CurrentPage: 1, PageSize: 10}
	pagination.ReadParam(params)
